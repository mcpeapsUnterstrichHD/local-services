...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.SESSIONS; 
INSERT INTO "PUBLIC"."SESSIONS"("SESSION_ID", "EXPIRED", "LAST_REQUEST", "PRINCIPAL_NAME") VALUES('node0obw5b0wga4u8qai58f8wvt591', TRUE, TIMESTAMP '2025-02-25 20:13:45.644', 'admin');       
INSERT INTO "PUBLIC"."SESSIONS"("SESSION_ID", "EXPIRED", "LAST_REQUEST", "PRINCIPAL_NAME") VALUES('node01fw4w8e0quuedc603rtnkyyua3', FALSE, TIMESTAMP '2025-02-25 20:14:29.334', 'mahd');      
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME") VALUES(1, NULL, 'web', FALSE, FALSE, '$2a$10$rYH4/jUxonjUzqMX9FccSuaRin0UuyYzejVjl5wiyoJAYyPi.cA6u', NULL, 'admin');
